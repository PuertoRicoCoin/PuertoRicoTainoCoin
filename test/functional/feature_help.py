...
"""Verify that starting puertoricotainocoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start puertoricotainocoin with -h for help text")
        ...
        self.log.info("Start puertoricotainocoin with -version for version information")
        ...
        self.log.info("Start puertoricotainocoind with -fakearg to make sure it does not start")
