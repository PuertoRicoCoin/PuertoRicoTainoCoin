# Support for Output Descriptors in PuertoRicoTainoCoin Core

Since PuertoRicoTainoCoin Core v0.17, there is support for Output Descriptors. This is a
...
- Segwit addresses (bech32, of the form `prtc1...` for mainnet or `tprtc1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
on PuertoRicoTainoCoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing PuertoRicoTainoCoin Core wallets, a convenience function `combo` is
